...
<main>
    <div class="section">
        <h2>
            ...
            <a class="excel" href="./${links.topByCarsCountZip}"><img src="${links.excelPng}" class="excel" alt="Скачать Excel" title="Скачать Excel"/>Скачать Excel (в архиве)</a>
        </h2>
    </div>

    <div class="section" id="table-container">

        <table class="data" aria-label="Топ-${players?size} по числу машин в гараже">
            <tr>
                <th scope="col">#</th>
