...
public class TopByBestSpeedTemplate extends FreemarkerTemplate {

    private static final String PLAYERS_KEY = "players";

    @Override
    public String getTemplatePath() {
        return "ftl/top-by-best-speed.ftl";
    }

    public TopByBestSpeedTemplate players(List<PlayerDto> players) {
    ...
    public void export(final String filePath) {
        ...
        logger.debug(
            "Top by best speed: {} players exported to file {}",
            getPlayers().size(),
            filePath
        );
    }
