const DomHelper = function () {
    ...
    return {
        ...
        createEl: function (tag, id, cls, text) {
            ...
            if (cls) {
                const cssClass = DomHelper.getClass(cls);
                if (cssClass) {
        ...
        createScriptEl: function (src) {
            const scriptElement = document.createElement(DomHelper.SCRIPT_TAG);
        ...
        createImg: function (src, alt) {
            const imgElement = document.createElement(DomHelper.IMG_TAG);
        ...
        appendCss: function (cssUrl, headId) {
            ...
            const cssLink = document.createElement(DomHelper.LINK_TAG);
            ...
            let headElement = document.getElementsByTagName(DomHelper.HEAD_TAG)[0];
            if (headId) {
        ...
        insertAfter: function (nodeBefore, nodeToInsert) {
            ...
            const parentNode = nodeBefore.parentNode;
